...
"Поиск значеня", JOptionPane.QUESTION_MESSAGE); 
 	 	...
 	 	JLabel labelForFrom = new JLabel("Интервал с"); 
 		...
 		if (args.length==0) { 
 	 	...
 	 	try {  	 	 	
 	 		...
 	 		{  	 	 	 	
 	 	 	...
 	 	 	System.out.println("Ошибка преоброзования строки" + args[i] + " в число типа Double"); 
 	 	 	System.exit(-2); 
 	 	} 
